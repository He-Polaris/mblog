...
<head>
    ...
    <link href="${base}/theme/delicate/dist/css/style.css" rel="stylesheet"/>
    <link href="${base}/theme/delicate/dist/css/animate-min.css" rel="stylesheet"/>
...
<body>
    <!-- header -->
    <#include "/delicate/inc/header.ftl"/>
    <!-- /header -->
    ...
    <!-- footer -->
    <#include "/delicate/inc/footer.ftl"/>
    <!-- 
    <script type="text/javascript">
