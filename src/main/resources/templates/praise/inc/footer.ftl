...
<script src="${base}/theme/praise/dist/js/swiper.min.js"></script>
<script src="${base}/theme/praise/dist/js/wow.min.js"></script>
<script src="${base}/theme/praise/dist/js/praise-unit.js"></script>
