    ...
    <#if row.thumbnail?? && row.thumbnail?length gt 0>
        <div class="content-box">
            ...
            <div class="posts-item posts-item-gallery">
                <h2><span><@utils.showChannel row/></span><a href="${base}/post/${row.id}"><#if escape>${row.title?html}<#else>${row.title}</#if></a></h2>
                ...
                <div class="item-info">
                    <ul>
                        ...
                        <li class="ico-eye"><i class="fa fa-eye"></i>${row.views}</li>
                        <li class="ico-like"><i class="fa fa-comments-o"></i>${row.comments}</li>
                    </ul>
                </div>
            </div>
        </div>
