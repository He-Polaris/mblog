...
<head>
    ...
    <link href="${base}/theme/praise/dist/css/style.css" rel="stylesheet"/>
    ...
    <link href="${base}/theme/praise/dist/css/swiper.min.css" rel="stylesheet"/>
    <link href="${base}/theme/praise/dist/css/praise-swiper.css" rel="stylesheet"/>
    <link href="${base}/theme/praise/dist/css/animate-min.css" rel="stylesheet"/>
